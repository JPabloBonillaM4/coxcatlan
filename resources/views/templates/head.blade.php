...
<html>
	<head>
		...
		<title>@yield('title','Coxcatlan | Inicio')</title>	

		<meta name="keywords" content="Coxcatlan" />
		<meta name="description" content="Coxcatlan, Puebla">
		...
		<!-- Current Page CSS -->
		<link rel="stylesheet" href="{{ asset('vendor/circle-flip-slideshow/css/component.css?v='.rand()) }}">
		<!-- Skin CSS -->
		<link rel="stylesheet" href="{{ asset('css/skins/default.css?v='.rand()) }}"> 
